...
module Biblio
  module Catalogue
    class EnregistrerAuteurTest < Minitest::Test
      def setup
        @repo = Biblio::Db::Container.resolve(:auteur_repository)
        @repo.clear!
      ...
      def test_enregistrer_auteur_success
        # Given
        demande_creation_auteur = RequestModels::EnregistrerAuteurRequest.new(nom: 'Bernard Dadié')
      ...
      def test_enregistrer_auteur_echec_validation
        # Given
        demande_creation_auteur = RequestModels::EnregistrerAuteurRequest.new(nom: nil)
      ...
      def test_enregistrer_auteur_echec_repository
        ...
        enregistrer_auteur_request = RequestModels::EnregistrerAuteurRequest.new(nom: 'Bernard Dadié')

        Adapters::AuteurRepository.stub :new, mock do
          @repo = Adapters::AuteurRepository.new
