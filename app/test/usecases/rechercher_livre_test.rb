...
class RechercherLivreTest < Minitest::Test
  ...
  def test_trouver_aucun_livre_sans_titre
    # Given
    rechercher_livre_request = UseCases::RechercherLivreRequest.new('')
  ...
  def test_trouver_aucun_livre
    # Given
    rechercher_livre_request = UseCases::RechercherLivreRequest.new('Livre non enregistré')
    presenter = Presenters::RechercherLivrePresenter.new
  ...
  def test_trouver_un_livre
    # Given
    rechercher_livre_request = UseCases::RechercherLivreRequest.new('Le vieux nègre et la médaille')
    presenter = Presenters::RechercherLivrePresenter.new
  ...
  def test_trouver_deux_livres
    # Given
    rechercher_livre_request = UseCases::RechercherLivreRequest.new('Le vieux')
    presenter = Presenters::RechercherLivrePresenter.new
